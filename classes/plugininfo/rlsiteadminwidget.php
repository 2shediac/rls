...
namespace local_rlsiteadmin\plugininfo;
 ...
 */
class rlsiteadminwidget extends \core\plugininfo\base {
    ...
    public $typerootdir = '/local/rlsiteadmin/widgets/';

    /** @var string the plugin name, eg. assignment, ldap */
    public $name = 'rlsiteadminwidget';

    /** @var string the localized plugin name */
    public $displayname = 'RL Site Admin Widgets';

    /** @var mixed human-readable release information */
    public $release = '3.1.0.0';

    public function get_settings_section_name() {
        return 'local_rlsiteadmin_settings_'.$this->component;
    }
