...
/**
 * @package rlsiteadminwidget_operatingsystemstats
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @copyright 2017 onwards Remote-Learner Inc (http://www.remote-learner.net)
 */

namespace rlsiteadminwidget_operatingsystemstats;
...
class widget extends \local_rlsiteadmin\lib\widgetbase {
    ...
    public function get_html($fullscreen = false) {
        ...
        $headertext = get_string('dashboard_operatingsystems_header', 'local_rlsiteadmin');
        ...
        $html .= '<div id="operatingsystemstats-graph"><div class="loading-spinner"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i>
<span class="sr-only">Loading...</span></div></div>';
        ...
        $html .= get_string('widget_info', 'rlsiteadminwidget_operatingsystemstats');
        $html .= '</div>';
        $html .= '</div>';
        $html .= '</div>';
        return $html;
