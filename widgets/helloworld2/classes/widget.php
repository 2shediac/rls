...
class widget extends \local_rlsiteadmin\lib\widgetbase {
    ...
    public function get_html($fullscreen = false) {
        ...
        if (empty($token)) {
            return \html_writer::tag('p', 'Failed retrieving Authorization token!'.\html_writer::empty_tag('br').$errstr, ['class' => 'alert']);
        }
