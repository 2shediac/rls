...
/**
 * @package rlsiteadminwidget_learningspaces
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @copyright 2015 onwards Remote-Learner Inc (http://www.remote-learner.net)
 */

namespace rlsiteadminwidget_learningspaces;
...
class widget extends \local_rlsiteadmin\lib\widgetbase {
    ...
    public function get_html($fullscreen = false) {
        ...
        if (!empty($CFG->behat_wwwroot) && $CFG->wwwroot == $CFG->behat_wwwroot) {
            return '<div class="behattest learningspaces">learningspaces</div>';
        }
        $html = '<iframe width="100%" height="260" src="https://widgetadmin.remote-learner.net/learning-spaces" frameborder="0"></iframe>';
        return $html;
    }
