...
class widget extends \local_rlsiteadmin\lib\widgetbase {
    ...
    public function get_html($fullscreen = false) {
        ...
        $html = '<iframe width="100%" height="545" src="'.$CFG->RL_DASH_URL.'/index_sso?token='.$token.'#/announcements" frameborder="0"></iframe>';
        return $html;
    }
